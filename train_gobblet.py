...
def main():
    ...
    cfg.value_net = [4096, 2048]
    cfg.value_batch_size = 1024
    cfg.value_batch_steps = 16384
    cfg.value_learning_rate = 1e-5
    cfg.regret_traversals = 4096
    cfg.regret_memory_capacity = int(2e5)
    cfg.regret_net = [4096, 2048]
    cfg.regret_batch_size = 1024
    cfg.regret_batch_steps = 16384
    cfg.regret_learning_rate = 1e-5
    cfg.avg_policy_memory_capacity = int(5e5)
    cfg.avg_policy_net = [4096, 4096]
    cfg.avg_policy_batch_size = 1024
    cfg.avg_policy_batch_steps = 32768
    cfg.avg_policy_learning_rate = 1e-5
